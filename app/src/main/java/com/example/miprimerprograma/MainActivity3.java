...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawable2 = res.getDrawable(R.drawable.devoluciones, getTheme());
        imagen2 =(ImageView) findViewById(R.id.image2);
        imagen2.setImageDrawable(drawable2);

        drawable3 = res.getDrawable(R.drawable.entrega_rapida, getTheme());
        imagen3 =(ImageView) findViewById(R.id.image3);
        imagen3.setImageDrawable(drawable3);

        drawable4 = res.getDrawable(R.drawable.bono, getTheme());
